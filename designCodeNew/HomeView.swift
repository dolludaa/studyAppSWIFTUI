...
struct WatchRingsView: View {
    var body: some View {
        HStack(spacing: 15) {
            HStack(spacing: 12.0) {
                RingView(color1: Color("colo"), color2: Color.white, width: 44, height: 44, percent: 53 , showCircle: .constant(true))
            ...
            HStack(spacing: 12.0) {
                ...
                RingView(color1: Color.pink, color2: Color.white, width: 32, height: 32, percent: 68, showCircle: .constant(true))
            }
            .padding(8)
            .background(Color.white)
            .cornerRadius(20)
            ...
            HStack(spacing: 12.0) {
                RingView(color1: Color("mycol3"), color2: Color.white, width: 32, height: 32, percent: 88 , showCircle: .constant(true))
            ...
            HStack(spacing: 12.0) {
                RingView(color1: Color.white, color2: Color.blue,width: 32, height: 32, percent: 90, showCircle: .constant(true))
